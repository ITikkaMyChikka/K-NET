...
class SystemModel:
    ...
    def GenerateSequence(self, Q_gen, R_gen):
        ...
        for t in range(0, self.T):
            ...
            eq = torch.distributions.multivariate_normal.MultivariateNormal(mean, Q_gen)
            ...
            er = torch.distributions.multivariate_normal.MultivariateNormal(mean, R_gen)
